...
__all__ += ["create_us", "create_team", "create_house_league"]
# function to update a record
__all__ += ["update_us", "update_ps", "update_rs", "update_team", "update_house_league"]
# function to delete a record
__all__ += ["delete_us", "delete_ps", "delete_rs", "delete_team", "delete_house_league"]
